...
/*    public void listarEmpleados() {
        ...
        try (Connection con = ConexionBD.getConexion(); // obtiene una conexión a la BD
             ...
             ResultSet rs = st.executeQuery("SELECT * FROM empleados")) { // ejecuta la consulta y obtiene los resultados

            // DatabaseMetaData: información sobre la base de datos y el driver
            ...
            System.out.println("USO DE RESUTLSETMETADATA");
